...
layout = [[t,t,t,t,t,t,t,_,_,_,t,t,t,t,t,t,t],
...
layout = [[_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_],
          ...
          [_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_],
          [_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_],
          [_,_,_,_,_,a,a,a,_,_,_,_,_,a,a,a,_],
          [_,_,_,_,_,a,_,_,_,_,_,_,_,_,_,a,_],
          [_,_,_,_,_,a,_,_,_,_,_,_,_,_,_,a,_],
          [_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_],
          [_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_],
          [_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_],
          ...
          [_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_],
          [_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_],
          [_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_]].reverse(),
...
layout = [[_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_],
          ...
          [_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_],
          [_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_],
          [_,_,_,_,_,_,_,a,_,_,_,_,_,a,_,_,_],
          [_,_,_,_,_,_,_,a,_,_,_,_,_,a,_,_,_],
          [_,_,_,_,_,_,_,a,_,_,_,_,_,a,_,_,_],
          [_,_,_,_,_,_,_,a,_,_,_,_,_,a,_,_,_],
          [_,_,_,_,_,_,_,a,_,_,_,_,_,a,_,_,_],
          [_,_,_,_,_,_,_,a,_,_,_,_,_,a,_,_,_],
          [_,_,_,_,_,_,_,a,a,a,a,a,a,a,_,_,_],
          [_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_],
          [_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_],
          [_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_],
          [_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_],
...
layout = [[_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_],
          ...
          [_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_],
          [_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_],
          [_,_,_,_,_,p,p,p,p,p,_,p,p,p,p,p,_],
          [_,_,_,_,_,p,_,_,_,_,_,_,_,_,_,p,_],
          [_,_,_,_,_,p,_,_,_,_,_,_,_,_,_,p,_],
          [_,_,_,_,_,p,_,_,_,_,_,_,_,_,_,p,_],
          [_,_,_,_,_,p,_,_,_,_,_,_,_,_,_,p,_],
          [_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_],
