...
siguienteNivel = segundoNivel, fondo = "piso_desierto.png", limiteDeEnemigosEnMapa = 3)
...
layout = [[_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_],
          ...
          [_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_],
          [_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_],
          [_,_,_,_,_,a,a,a,_,_,_,_,_,a,a,a,_,_,_,_,_],
          [_,_,_,_,_,a,_,_,_,_,_,_,_,_,_,a,_,_,_,_,_],
          [_,_,_,_,_,a,_,_,_,_,_,_,_,_,_,a,_,_,_,_,_],
          [_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_],
          [_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_],
          [_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_],
...
enemigosIniciales = [zmb, zmb, zmb, zmb,
                     ...
                     zmb, zmb, zmb, zmb,
                     zmb, zmb, zmb, zmb],
siguienteNivel = tercerNivel, fondo = "piso_pradera.png")
...
layout = [[_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_],
          ...
          [_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_],
          [_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_],
          [_,_,_,_,_,_,_,a,_,_,_,_,_,a,_,_,_,_,_,_,_],
          [_,_,_,_,_,_,_,a,_,_,_,_,_,a,_,_,_,_,_,_,_],
          [_,_,_,_,_,_,_,a,_,_,_,_,_,a,_,_,_,_,_,_,_],
          [_,_,_,_,_,_,_,a,_,_,_,_,_,a,_,_,_,_,_,_,_],
          [_,_,_,_,_,_,_,a,_,_,_,_,_,a,_,_,_,_,_,_,_],
          [_,_,_,_,_,_,_,a,_,_,_,_,_,a,_,_,_,_,_,_,_],
          [_,_,_,_,_,_,_,a,a,a,a,a,a,a,_,_,_,_,_,_,_],
          [_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_],
          [_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_],
          [_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_],
          [_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_],
...
enemigosIniciales = [zmb, zmb, zmb, zmb,
                     ...
                     zmb, zmb, zmb, zmb,
                     zmb, zmb, zmb, zmb],
siguienteNivel = cuartoNivel, fondo = "piso_pradera.png")
...
layout = [[_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_],
          ...
          [_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_],
          [_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_],
          [_,_,_,_,_,p,p,p,p,p,_,p,p,p,p,p,_,_,_,_,_],
          [_,_,_,_,_,p,_,_,_,_,_,_,_,_,_,p,_,_,_,_,_],
          [_,_,_,_,_,p,_,_,_,_,_,_,_,_,_,p,_,_,_,_,_],
          [_,_,_,_,_,p,_,_,_,_,_,_,_,_,_,p,_,_,_,_,_],
          [_,_,_,_,_,p,_,_,_,_,_,_,_,_,_,p,_,_,_,_,_],
          [_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_],
...
enemigosIniciales = [zmb, zmb, zmb, zmb,
                     ...
                     zmb, zmb, zmb, zmb,
                     zmb, zmb, zmb, zmb],
siguienteNivel = nivelFinal, fondo = "piso_cueva.png")
...
layout = [[_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_],
          ...
          [_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_,_]].reverse(),
enemigosIniciales = [],
siguienteNivel = self, fondo = "piso_desierto.png")
{
